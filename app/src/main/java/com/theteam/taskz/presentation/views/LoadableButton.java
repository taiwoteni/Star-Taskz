...
public class LoadableButton extends LinearLayout {
    ...
    public void setEnabled(boolean enabled) {
        if(!enabled){
            root_layout.setBackgroundTintList(ColorStateList.valueOf(new ThemeManager(getContext()).tertiary));
            button_text.setTextColor(new ThemeManager(getContext()).secondary);
        }
        else{
            root_layout.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.themeColor)));
