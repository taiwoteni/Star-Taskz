...
public class TaskModel {
    ...
    public HashMap<String,Object> toJson(){
        ...
        json.put("time", startTime.getTimeInMillis());
    ...
    public JSONObject toJsonObject() throws JSONException {
        ...
        Calendar endDate = (Calendar) this.startTime.clone();
        final int dayOfYear = startTime.get(Calendar.DAY_OF_YEAR);
        final int year = startTime.get(Calendar.YEAR);
        boolean isLeapYear = startTime.get(Calendar.YEAR)%4 ==0;
        boolean isLastDay = isLeapYear? dayOfYear==365:dayOfYear==366;
        endDate.set(Calendar.DAY_OF_YEAR, isLastDay? 1: startTime.get(Calendar.DAY_OF_YEAR)+1);
        ...
        jsonObject.put("taskDescription", description);
        jsonObject.put("startedAt", isoFormat.format(startTime.getTime()));
